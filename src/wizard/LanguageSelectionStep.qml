...
WizardStepBase {
    ...
    title: qsTr("Welcome")
    subtitle: qsTr("Choose your language for Laerdal SimServer Imager")
            ...
            WizardSectionContainer {
                RowLayout {
                    ...
                    ImComboBox {
                        ...
                        Accessible.description: qsTr("Select the language for the Laerdal SimServer Imager interface")
