# GenerateTimezones.cmake CMake script to download IANA timezone data and
# generate timezone list Called with: -DTZDATA_URL=<url> -DTZDATA_DIR=<dir>
# -DOUTPUT_FILE=<file> -DSOURCE_DIR=<dir>
...
file(
  DOWNLOAD "${TZDATA_URL}" "${TZDATA_ARCHIVE}"
  SHOW_PROGRESS
...
foreach(line ${zone_lines})
  ...
  if(line AND NOT line MATCHES "^#")
    # zone.tab format: country_code coordinates timezone_name [comments] We want
    # the third column (timezone_name)
...
# Add some additional timezones that might not be in zone.tab but are commonly
# used
list(
  APPEND
  timezone_list
