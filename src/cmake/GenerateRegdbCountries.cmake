...
# GenerateRegdbCountries.cmake CMake script to download wireless-regdb db.txt
# and generate a list of two-letter regulatory domain codes. Falls back to
# countries.txt in source tree if download fails.
#
# Called with: -DREGDB_URL=<url> -DOUTPUT_FILE=<file> -DSOURCE_DIR=<dir>
...
message(
  STATUS
    "Generated ${num_codes} wireless regulatory country codes into ${OUTPUT_FILE}"
)
