...
# Find liburing for async I/O (Linux 5.1+) Uses pkg-config since liburing
# doesn't have a CMake config
...
if(LIBURING_FOUND)
  ...
  message(
    WARNING
      "liburing not found - async I/O will be disabled. Install with: sudo apt install liburing-dev"
  )
endif()
...
if(NOT BUILD_CLI_ONLY)
  ...
  list(APPEND PLATFORM_SOURCES linux/suspend_inhibitor_stub.cpp
