...
static bool installPolkitPolicyForPath(const char* appImagePath) {
    ...
    QString policyContent = QString(
        ...
        "<policyconfig>\n"
        "  <vendor>Laerdal Medical</vendor>\n"
        "  <vendor_url>https://www.laerdal.com/</vendor_url>\n"
        "  <action id=\"%1\">\n"
        "    <description>Run Laerdal SimServer Imager</description>\n"
        "    <message>Authentication is required to run Laerdal SimServer Imager</message>\n"
        "    <icon_name>laerdal-simserver-imager</icon_name>\n"
        "    <defaults>\n"
