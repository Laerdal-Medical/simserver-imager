...
ICONSET_DIR="$PROJECT_ROOT/src/icons/laerdal-simserver-imager.iconset"
ICNS_FILE="$PROJECT_ROOT/src/icons/laerdal-simserver-imager.icns"
...
echo "  • Include laerdal-simserver-imager.icns in the app bundle"
